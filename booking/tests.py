...
class RoomsTestCases(TestCase):
    def setUp(self):
        ...
        Rooms.objects.create(manager=manager, room_no=300, room_type='Deluxe', price=3000, is_available=True,
                             no_of_days_advance=10, start_date='2020-03-20')
        Rooms.objects.create(manager=manager, room_no=301, room_type='Super Deluxe', price=5000, is_available=True,
